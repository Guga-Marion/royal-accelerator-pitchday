# Kamila Adamatti · Liderança · pessoas, delegação e cultura de execução

> Preencha com o que vier em `_fontes/` (bio, fotos, links). Cada fato público leva fonte. O que só ele sabe, marcar *[validar com a Kamila]*.
...
## A frase-régua
O que a Kamila olha primeiro numa empresa (liga com o estático "A banca fala"):

## Perguntas para a Kamila (áudio de 5 min resolve)
