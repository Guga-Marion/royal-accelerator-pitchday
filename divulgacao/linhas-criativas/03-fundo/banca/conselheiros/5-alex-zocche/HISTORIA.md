# Alex Zocche · Processos · SOPs, rotina de operação e preparo para escala

> Preencha com o que vier em `_fontes/` (bio, fotos, links). Cada fato público leva fonte. O que só ele sabe, marcar *[validar com o Alex]*.

## Ficha
- **Cadeira na RBG:** Processos · SOPs, rotina de operação e preparo para escala
...
## A frase-régua
O que o Alex olha primeiro numa empresa (liga com o estático "A banca fala"):

## Perguntas para o Alex (áudio de 5 min resolve)
