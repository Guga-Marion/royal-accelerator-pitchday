# Lúcio Santana · Founder & chairman · preside o comitê de investimento

> Preencha com o que vier em `_fontes/` (bio, fotos, links). Cada fato público leva fonte. O que só ele sabe, marcar *[validar com o Lúcio]*.

## Ficha
- **Cadeira na RBG:** Founder & chairman · preside o comitê de investimento
...
## A frase-régua
O que o Lúcio olha primeiro numa empresa (liga com o estático "A banca fala"):

## Perguntas para o Lúcio (áudio de 5 min resolve)
